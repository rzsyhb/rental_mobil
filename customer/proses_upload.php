...
$bukti = upload_gambar('bukti', '../uploads/bukti');
$simA = upload_gambar_terenkripsi('sim_a', 'sim_a');

if (empty($bukti) || empty($simA)) {
    echo "<script>alert('Upload bukti pembayaran dan SIM A wajib berupa gambar JPG/PNG/WEBP.');window.history.back();</script>";
    exit;
}
