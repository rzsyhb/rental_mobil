...
if (!function_exists('admin_menu_items')) {
    function admin_menu_items()
    {
        return [
            ...
            'mobil' => ['label' => 'Data Mobil', 'icon' => 'bi bi-car-front', 'href' => 'mobil.php'],
            'customer' => ['label' => 'Data User', 'icon' => 'bi bi-people', 'href' => 'customer.php'],
            'transaksi' => ['label' => 'Transaksi', 'icon' => 'bi bi-receipt', 'href' => 'transaksi.php'],
            'laporan' => ['label' => 'Laporan', 'icon' => 'bi bi-file-earmark-bar-graph', 'href' => 'laporan.php'],
            'analitik' => ['label' => 'Analitik', 'icon' => 'bi bi-bar-chart-line', 'href' => 'analitik.php'],
...
if (!function_exists('admin_page_start')) {
    function admin_page_start($title, $active = 'dashboard', $extraHead = '')
    {
        $menu = admin_menu_items();
        $pageTitle = htmlspecialchars($title, ENT_QUOTES, 'UTF-8');
        $userName = htmlspecialchars($_SESSION['nama'] ?? 'Admin', ENT_QUOTES, 'UTF-8');
...
<body class="layout-fixed sidebar-expand-lg dashboard-page">
<div class="app-wrapper">
    <nav class="app-header navbar navbar-expand admin-header border-0 shadow-sm">
    ...
    <aside class="app-sidebar admin-sidebar shadow" data-bs-theme="light">
            ...
            <a href="dashboard.php" class="brand-link text-decoration-none border-0">
                <div class="brand-logo-row">
                    ...
                    <span class="brand-copy">
                        <span class="brand-main">ADMIN PANEL</span>
                        <span class="brand-sub">Brawijaya Rental</span>
                    </span>
                </div>
            </a>
        </div>
...
if (!function_exists('admin_page_end')) {
    function admin_page_end($extraScripts = '')
    {
        echo <<<HTML
            </div>
        </div>
